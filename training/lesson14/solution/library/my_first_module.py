...
def run_module():
    ...
    result['original_message'].append({"name": module.params['name']})
    result['original_message'].append({"action": module.params['action']})
    result['message'] = module.params['name'] + ' would like to ' + module.params['action'] 
